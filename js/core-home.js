...
const USERS={
  ...
  'gerencia': {pass:'gestion25', name:'Gerencia',       initials:'GR', modules:['resultados','flujo','stock','insumos','mercado','tesoreria','simulador','historico','remitos','analisis-costos','acumulados','compras','baseparams']},
  'admin':    {pass:'admin123',  name:'Administrador',  initials:'AD', modules:['resultados','flujo','stock','insumos','mercado','tesoreria','simulador','historico','remitos','analisis-costos','acumulados','compras','baseparams']},
};
